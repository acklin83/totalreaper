...
namespace ImGui {
  ...
  REAIMGUIAPI_EXTERN int ButtonFlags_EnableNav;
  ...
  REAIMGUIAPI_EXTERN int ColorEditFlags_AlphaNoBg;
  REAIMGUIAPI_EXTERN int ColorEditFlags_AlphaOpaque;
  ...
  REAIMGUIAPI_EXTERN int SelectableFlags_Highlight;
  REAIMGUIAPI_EXTERN int SelectableFlags_NoAutoClosePopups;
  ...
  REAIMGUIAPI_EXTERN int ConfigVar_DebugHighlightIdConflicts;
  ...
  REAIMGUIAPI_EXTERN int ConfigVar_NavCaptureKeyboard;
  REAIMGUIAPI_EXTERN int ConfigVar_NavCursorVisibleAlways;
  REAIMGUIAPI_EXTERN int ConfigVar_NavCursorVisibleAuto;
  REAIMGUIAPI_EXTERN int ConfigVar_NavEscapeClearFocusItem;
  REAIMGUIAPI_EXTERN int ConfigVar_NavEscapeClearFocusWindow;
  REAIMGUIAPI_EXTERN int ConfigVar_NavMoveSetMousePos;
  REAIMGUIAPI_EXTERN int ConfigVar_ScrollbarScrollByPage;
  ...
  REAIMGUIAPI_EXTERN int SliderFlags_ClampOnInput;
  REAIMGUIAPI_EXTERN int SliderFlags_ClampZeroRange;
  ...
  REAIMGUIAPI_EXTERN int SliderFlags_NoSpeedTweaks;
  ...
  REAIMGUIAPI_EXTERN details::function<ImGui_Font*(const char* family, details::optional<int> flagsInOptional), true> CreateFont;
  REAIMGUIAPI_EXTERN details::function<ImGui_Font*(const char* file, details::optional<int> indexInOptional, details::optional<int> flagsInOptional), true> CreateFontFromFile;
  REAIMGUIAPI_EXTERN details::function<ImGui_Font*(const char* data, int data_sz, details::optional<int> indexInOptional, details::optional<int> flagsInOptional), true> CreateFontFromMem;
  ...
  REAIMGUIAPI_EXTERN details::function<void(ImGui_Context* ctx, ImGui_Font* font, double font_size_base_unscaled)> PushFont;
  ...
  REAIMGUIAPI_EXTERN details::function<ImGui_Image*(int width, int height, details::optional<int> flagsInOptional), true> CreateImageFromSize;
  REAIMGUIAPI_EXTERN details::function<void(ImGui_Context* ctx, ImGui_Image* image, double image_size_w, double image_size_h, details::optional<double> uv0_xInOptional, details::optional<double> uv0_yInOptional, details::optional<double> uv1_xInOptional, details::optional<double> uv1_yInOptional)> Image;
  ...
  REAIMGUIAPI_EXTERN details::function<void(ImGui_Bitmap* image, int x, int y, int w, int h, reaper_array* pixels, details::optional<int> offsetInOptional, details::optional<int> pitchInOptional)> Image_GetPixels_Array;
  REAIMGUIAPI_EXTERN details::function<void(ImGui_Image* image, double* wOut, double* hOut)> Image_GetSize;
  REAIMGUIAPI_EXTERN details::function<void(ImGui_Bitmap* image, int x, int y, int w, int h, reaper_array* pixels, details::optional<int> offsetInOptional, details::optional<int> pitchInOptional)> Image_SetPixels_Array;
  REAIMGUIAPI_EXTERN details::function<ImGui_ImageSet*(), true> CreateImageSet;
  REAIMGUIAPI_EXTERN int ImageFlags_NoErrors;
  REAIMGUIAPI_EXTERN int ImageFlags_None;
  ...
  REAIMGUIAPI_EXTERN details::function<void(ImGui_Context* ctx)> PopItemFlag;
  REAIMGUIAPI_EXTERN details::function<void(ImGui_Context* ctx, int option, bool enabled)> PushItemFlag;
  ...
  REAIMGUIAPI_EXTERN details::function<void(ImGui_Context* ctx, bool visible)> SetNavCursorVisible;
  ...
  REAIMGUIAPI_EXTERN int ItemFlags_AllowDuplicateId;
  REAIMGUIAPI_EXTERN int ItemFlags_AutoClosePopups;
  REAIMGUIAPI_EXTERN int ItemFlags_ButtonRepeat;
  REAIMGUIAPI_EXTERN int ItemFlags_NoNav;
  REAIMGUIAPI_EXTERN int ItemFlags_NoNavDefaultFocus;
  REAIMGUIAPI_EXTERN int ItemFlags_NoTabStop;
  REAIMGUIAPI_EXTERN int ItemFlags_None;
  ...
  REAIMGUIAPI_EXTERN int Key_Oem102;
  ...
  REAIMGUIAPI_EXTERN details::function<bool(ImGui_Context* ctx, int button, double delay)> IsMouseReleasedWithDelay;
  ...
  REAIMGUIAPI_EXTERN int MouseCursor_Progress;
  ...
  REAIMGUIAPI_EXTERN int MouseCursor_Wait;
  ...
  REAIMGUIAPI_EXTERN details::function<void(ImGui_ListClipper* clipper, int items_count)> ListClipper_SeekCursorForItem;
  ...
  REAIMGUIAPI_EXTERN int Col_TextLink;
  ...
  REAIMGUIAPI_EXTERN int Col_TreeLines;
  ...
  REAIMGUIAPI_EXTERN details::function<void(ImGui_Context* ctx, int idx, double val1, details::optional<double> val2InOptional)> PushStyleVar;
  REAIMGUIAPI_EXTERN details::function<void(ImGui_Context* ctx, int idx, double val_x)> PushStyleVarX;
  REAIMGUIAPI_EXTERN details::function<void(ImGui_Context* ctx, int idx, double val_y)> PushStyleVarY;
  ...
  REAIMGUIAPI_EXTERN int StyleVar_ImageBorderSize;
  ...
  REAIMGUIAPI_EXTERN int StyleVar_TabBarOverlineSize;
  ...
  REAIMGUIAPI_EXTERN int StyleVar_TreeLinesRounding;
  REAIMGUIAPI_EXTERN int StyleVar_TreeLinesSize;
  ...
  REAIMGUIAPI_EXTERN details::function<bool(ImGui_Context* ctx, const char* label)> TextLink;
  REAIMGUIAPI_EXTERN details::function<bool(ImGui_Context* ctx, const char* label, details::optional<const char*> urlInOptional)> TextLinkOpenURL;
  ...
  REAIMGUIAPI_EXTERN int InputTextFlags_ElideLeft;
  ...
  REAIMGUIAPI_EXTERN int TreeNodeFlags_DrawLinesFull;
  REAIMGUIAPI_EXTERN int TreeNodeFlags_DrawLinesNone;
  REAIMGUIAPI_EXTERN int TreeNodeFlags_DrawLinesToNodes;
  REAIMGUIAPI_EXTERN int TreeNodeFlags_FramePadding;
  REAIMGUIAPI_EXTERN int TreeNodeFlags_Framed;
  REAIMGUIAPI_EXTERN int TreeNodeFlags_LabelSpanAllColumns;
  REAIMGUIAPI_EXTERN int TreeNodeFlags_Leaf;
  REAIMGUIAPI_EXTERN int TreeNodeFlags_NavLeftJumpsToParent;
  ...
  REAIMGUIAPI_EXTERN int TreeNodeFlags_SpanLabelWidth;
  ...
  REAIMGUIAPI_EXTERN details::function<void(ImGui_Context* ctx, const char* text)> DebugLog;
  ...
  REAIMGUIAPI_EXTERN int ChildFlags_Borders;
...
void ImGui::init(void *(*plugin_getapi)(const char *))
{
  ...
  ButtonFlags_EnableNav = details::get_enum(get_func(version, "ButtonFlags_EnableNav")); details::check_error();
  ...
  ColorEditFlags_AlphaNoBg = details::get_enum(get_func(version, "ColorEditFlags_AlphaNoBg")); details::check_error();
  ColorEditFlags_AlphaOpaque = details::get_enum(get_func(version, "ColorEditFlags_AlphaOpaque")); details::check_error();
  ...
  SelectableFlags_Highlight = details::get_enum(get_func(version, "SelectableFlags_Highlight")); details::check_error();
  SelectableFlags_NoAutoClosePopups = details::get_enum(get_func(version, "SelectableFlags_NoAutoClosePopups")); details::check_error();
  ...
  ConfigVar_DebugHighlightIdConflicts = details::get_enum(get_func(version, "ConfigVar_DebugHighlightIdConflicts")); details::check_error();
  ...
  ConfigVar_NavCaptureKeyboard = details::get_enum(get_func(version, "ConfigVar_NavCaptureKeyboard")); details::check_error();
  ConfigVar_NavCursorVisibleAlways = details::get_enum(get_func(version, "ConfigVar_NavCursorVisibleAlways")); details::check_error();
  ConfigVar_NavCursorVisibleAuto = details::get_enum(get_func(version, "ConfigVar_NavCursorVisibleAuto")); details::check_error();
  ConfigVar_NavEscapeClearFocusItem = details::get_enum(get_func(version, "ConfigVar_NavEscapeClearFocusItem")); details::check_error();
  ConfigVar_NavEscapeClearFocusWindow = details::get_enum(get_func(version, "ConfigVar_NavEscapeClearFocusWindow")); details::check_error();
  ConfigVar_NavMoveSetMousePos = details::get_enum(get_func(version, "ConfigVar_NavMoveSetMousePos")); details::check_error();
  ConfigVar_ScrollbarScrollByPage = details::get_enum(get_func(version, "ConfigVar_ScrollbarScrollByPage")); details::check_error();
  ...
  SliderFlags_ClampOnInput = details::get_enum(get_func(version, "SliderFlags_ClampOnInput")); details::check_error();
  SliderFlags_ClampZeroRange = details::get_enum(get_func(version, "SliderFlags_ClampZeroRange")); details::check_error();
  ...
  SliderFlags_NoSpeedTweaks = details::get_enum(get_func(version, "SliderFlags_NoSpeedTweaks")); details::check_error();
  ...
  CreateFontFromFile = get_func(version, "CreateFontFromFile"); details::check_error();
  ...
  CreateImageFromSize = get_func(version, "CreateImageFromSize"); details::check_error();
  Image = get_func(version, "Image"); details::check_error();
  ImageButton = get_func(version, "ImageButton"); details::check_error();
  ImageWithBg = get_func(version, "ImageWithBg"); details::check_error();
  Image_GetPixels_Array = get_func(version, "Image_GetPixels_Array"); details::check_error();
  Image_GetSize = get_func(version, "Image_GetSize"); details::check_error();
  Image_SetPixels_Array = get_func(version, "Image_SetPixels_Array"); details::check_error();
  CreateImageSet = get_func(version, "CreateImageSet"); details::check_error();
  ImageFlags_NoErrors = details::get_enum(get_func(version, "ImageFlags_NoErrors")); details::check_error();
  ImageFlags_None = details::get_enum(get_func(version, "ImageFlags_None")); details::check_error();
  ...
  PopItemFlag = get_func(version, "PopItemFlag"); details::check_error();
  PushItemFlag = get_func(version, "PushItemFlag"); details::check_error();
  ...
  SetNavCursorVisible = get_func(version, "SetNavCursorVisible"); details::check_error();
  ...
  ItemFlags_AllowDuplicateId = details::get_enum(get_func(version, "ItemFlags_AllowDuplicateId")); details::check_error();
  ItemFlags_AutoClosePopups = details::get_enum(get_func(version, "ItemFlags_AutoClosePopups")); details::check_error();
  ItemFlags_ButtonRepeat = details::get_enum(get_func(version, "ItemFlags_ButtonRepeat")); details::check_error();
  ItemFlags_NoNav = details::get_enum(get_func(version, "ItemFlags_NoNav")); details::check_error();
  ItemFlags_NoNavDefaultFocus = details::get_enum(get_func(version, "ItemFlags_NoNavDefaultFocus")); details::check_error();
  ItemFlags_NoTabStop = details::get_enum(get_func(version, "ItemFlags_NoTabStop")); details::check_error();
  ItemFlags_None = details::get_enum(get_func(version, "ItemFlags_None")); details::check_error();
  ...
  Key_Oem102 = details::get_enum(get_func(version, "Key_Oem102")); details::check_error();
  ...
  IsMouseReleasedWithDelay = get_func(version, "IsMouseReleasedWithDelay"); details::check_error();
  ...
  MouseCursor_Progress = details::get_enum(get_func(version, "MouseCursor_Progress")); details::check_error();
  ...
  MouseCursor_Wait = details::get_enum(get_func(version, "MouseCursor_Wait")); details::check_error();
  ...
  ListClipper_SeekCursorForItem = get_func(version, "ListClipper_SeekCursorForItem"); details::check_error();
  ...
  Col_InputTextCursor = details::get_enum(get_func(version, "Col_InputTextCursor")); details::check_error();
  ...
  Col_NavCursor = details::get_enum(get_func(version, "Col_NavCursor")); details::check_error();
  ...
  Col_TextLink = details::get_enum(get_func(version, "Col_TextLink")); details::check_error();
  ...
  Col_TreeLines = details::get_enum(get_func(version, "Col_TreeLines")); details::check_error();
  ...
  PushStyleVarX = get_func(version, "PushStyleVarX"); details::check_error();
  PushStyleVarY = get_func(version, "PushStyleVarY"); details::check_error();
  ...
  StyleVar_ImageBorderSize = details::get_enum(get_func(version, "StyleVar_ImageBorderSize")); details::check_error();
  ...
  StyleVar_TabBarOverlineSize = details::get_enum(get_func(version, "StyleVar_TabBarOverlineSize")); details::check_error();
  ...
  StyleVar_TreeLinesRounding = details::get_enum(get_func(version, "StyleVar_TreeLinesRounding")); details::check_error();
  StyleVar_TreeLinesSize = details::get_enum(get_func(version, "StyleVar_TreeLinesSize")); details::check_error();
  ...
  TextLink = get_func(version, "TextLink"); details::check_error();
  TextLinkOpenURL = get_func(version, "TextLinkOpenURL"); details::check_error();
  ...
  InputTextFlags_ElideLeft = details::get_enum(get_func(version, "InputTextFlags_ElideLeft")); details::check_error();
  ...
  TreeNodeFlags_DrawLinesFull = details::get_enum(get_func(version, "TreeNodeFlags_DrawLinesFull")); details::check_error();
  TreeNodeFlags_DrawLinesNone = details::get_enum(get_func(version, "TreeNodeFlags_DrawLinesNone")); details::check_error();
  TreeNodeFlags_DrawLinesToNodes = details::get_enum(get_func(version, "TreeNodeFlags_DrawLinesToNodes")); details::check_error();
  ...
  TreeNodeFlags_LabelSpanAllColumns = details::get_enum(get_func(version, "TreeNodeFlags_LabelSpanAllColumns")); details::check_error();
  TreeNodeFlags_Leaf = details::get_enum(get_func(version, "TreeNodeFlags_Leaf")); details::check_error();
  TreeNodeFlags_NavLeftJumpsToParent = details::get_enum(get_func(version, "TreeNodeFlags_NavLeftJumpsToParent")); details::check_error();
  ...
  TreeNodeFlags_SpanLabelWidth = details::get_enum(get_func(version, "TreeNodeFlags_SpanLabelWidth")); details::check_error();
  ...
  DebugLog = get_func(version, "DebugLog"); details::check_error();
  ...
  ChildFlags_Borders = details::get_enum(get_func(version, "ChildFlags_Borders")); details::check_error();
